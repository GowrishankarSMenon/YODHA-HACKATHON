...
import { Calendar, FileText, Activity, Pill, FlaskConical, Stethoscope, Download, Share2, Eye, Image as ImageIcon } from 'lucide-react';
                                        ...
                                        >
                                            ...
                                            <div className="p-5 pb-4">
                                                <div className="flex items-start gap-4">
                                                    ...
                                                    {/* Medical Record Image Thumbnail */}
                                                    {record.file_url && (
                                                        <div className="flex-shrink-0">
                                                            <div className="w-20 h-20 rounded-lg overflow-hidden border-2 border-gray-200 group-hover:border-blue-400 transition-colors shadow-sm">
                                                                <img
